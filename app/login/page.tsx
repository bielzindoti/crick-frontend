...
import { ArrowLeft, Eye, EyeOff, Lock, Mail, Smartphone } from "lucide-react"
import Image from "next/image"

export default function LoginPage() {
  const [showPassword, setShowPassword] = useState(false)
  const [loginMethod, setLoginMethod] = useState<"email" | "telefone">("email")
          ...
          <div className="max-w-md mx-auto">
            <div className="rounded-2xl border border-border bg-card shadow-sm overflow-hidden">
              ...
              <div className="p-6 text-center border-b border-border">
                ...
                />
                <h1 className="text-2xl font-bold text-card-foreground">Entrar no UmCrick!</h1>
              ...
              <form onSubmit={handleSubmit} className="p-6 space-y-4">
                ...
                <div className="flex items-center gap-2">
                  <Checkbox
                    ...
                    onCheckedChange={(checked) => updateFormData("lembrar", checked as boolean)}
                  />
              ...
              {/* Register Link */}
              <div className="border-t border-border p-6 text-center bg-muted/30">
